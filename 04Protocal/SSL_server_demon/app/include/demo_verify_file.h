#ifndef _DEMO_VERIFY_FILE_H_
#define _DEMO_VERIFY_FILE_H_

const static char demo_key[] =
        "-----BEGIN PRIVATE KEY-----\r\n"
        ...
        "-----END PRIVATE KEY-----\r\n"
        ;
static int demo_key_len = sizeof(demo_key);

const static char demo_crt[] =
        "-----BEGIN CERTIFICATE-----\r\n"
        ...
        "-----END CERTIFICATE-----\r\n"
        ;
static int demo_crt_len = sizeof(demo_crt);
