...
2. Enter SDK folder:/home/esp8266/Share/ESP8266_RTOS_SDK, Copy example folder "PMW" next to bin/ folder in the SDK folder. The SDK folder should have folders inside it like : bin, examples, third party...
